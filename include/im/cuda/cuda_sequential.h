...
#ifndef IM_CUDA_CUDA_SEQUENTIAL_H
#define IM_CUDA_CUDA_SEQUENTIAL_H
...
//void cuda_sequential(res_t &rrr_sets, const GraphTy &G, size_t theta,
...
#endif  // IM_CUDA_CUDA_SEQUENTIAL_H
